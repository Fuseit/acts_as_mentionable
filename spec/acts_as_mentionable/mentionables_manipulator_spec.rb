RSpec.describe ActsAsMentionable::MentionablesManipulator do
  ...
  let(:first_mentionable) { double 'First mentionable' }
  let(:second_mentionable) { double 'Second mentionable' }
  let(:third_mentionable) { double 'Third mentionable' }
  let(:fourth_mentionable) { double 'Fourth mentionable' }
